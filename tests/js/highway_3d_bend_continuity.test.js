...
function harness(strings = 6, inverted = false, lefty = false) {
    return new Function('nStr', '_invertedCached', '_leftyCached', `
        ...
        ${['bnvSampleAt','bendCurveStartSemis','bendCurveSemisAt','bendSemisAtElapsed',
            'resolveLinkedBendStarts','bendSemisAtTime','bendVisualDirY','noteHasVibrato',
        ...
        return {
            link(notes,chords=[]) {
                ...
                _linkedBendStarts=resolveLinkedBendStarts(links);
                return {links,targets,starts:_linkedBendStarts};
            },
            ...
            linkedElapsed(n,elapsed){return bendSemisAtElapsed(n,elapsed,_linkedBendStarts.get(n)||0);},
