...
Both stem switches live under **Note appearance**, apply only to RS+ inspired, and update immediately. The split-screen panel's **3D settings** expose notation style, both stem switches, Glow, and Soft glow / bloom independently for each panel. Global settings apply wherever no panel override is saved.
